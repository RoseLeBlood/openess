...
64 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_ac205e3a8f4f3786d88d5462ab8847414}\label{ess__socket_8c_ac205e3a8f4f3786d88d5462ab8847414}} 
...
243 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a92086273c5befc16e7a4821fcdefa71b}\label{ess__socket_8c_a92086273c5befc16e7a4821fcdefa71b}} 
...
138 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a5c657bebe31d11c04ef7d7df48087376}\label{ess__socket_8c_a5c657bebe31d11c04ef7d7df48087376}} 
...
371 
372   \textcolor{keywordflow}{if} ( -1 == getsockname(\_socket->\hyperlink{structess__socket_a3666576f6b88007cc7b8f26c7da596c8}{socket},(\textcolor{keyword}{struct} sockaddr*)&oldsockaddr,&oldsockaddrlen) )\{
...
391     \textcolor{keywordflow}{if} (  connect(\_socket->\hyperlink{structess__socket_a3666576f6b88007cc7b8f26c7da596c8}{socket},result\_check->ai\_addr,result\_check->ai\_addrlen) != -1) \textcolor{comment}{// connected
       without error}
...
399 
400   \_socket->\hyperlink{structess__socket_a4d0d74743d167680649419163ce8c80e}{hostname\_len} = strlen(host);
401   strncpy(\_socket->\hyperlink{structess__socket_a0c6be700c8763c26054098348ebef8d6}{hostname}, host, \_socket->\hyperlink{structess__socket_a4d0d74743d167680649419163ce8c80e}{hostname\_len});
402   \_socket->\hyperlink{structess__socket_a938bdc6ae46c346147b6d4f67ad1e704}{port} = port;
403 
...
405 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_adef36f85812a91bfa3ded44e273d4c18}\label{ess__socket_8c_adef36f85812a91bfa3ded44e273d4c18}} 
...
309 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a78d5b3a7daf7c40ab4b3a30ef8205ccc}\label{ess__socket_8c_a78d5b3a7daf7c40ab4b3a30ef8205ccc}} 
...
354 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a62c983ed003d1db7341a50b0ef1a98ed}\label{ess__socket_8c_a62c983ed003d1db7341a50b0ef1a98ed}} 
...
68   \textcolor{keywordflow}{if}( \_socket->\hyperlink{structess__socket_a4e47521e8af756b9edf77f1f02f9b725}{status} == \hyperlink{ess__socket_8h_a85c5abde0574d4a5fbf9e220a18e89dca37cf1e968a55c1fffcf40faa6fe58bd2}{ESS\_SOCKET\_STATUS\_STOPPED})
...
70 
71   \_socket->\hyperlink{structess__socket_ad09623d57ebd33fef8dac4e18c0cba2f}{family} = fam;
72   \_socket->\hyperlink{structess__socket_a1f0429596710512357072b192ba3d2bd}{protokol} = protokoll;
73   \_socket->\hyperlink{structess__socket_a938bdc6ae46c346147b6d4f67ad1e704}{port} = port;
74   \_socket->\hyperlink{structess__socket_a4e47521e8af756b9edf77f1f02f9b725}{status} = \hyperlink{ess__socket_8h_a85c5abde0574d4a5fbf9e220a18e89dca12156322e5e18ca7411b18dba57b9874}{ESS\_SOCKET\_STATUS\_CREATED};
75   \_socket->\hyperlink{structess__socket_a0c6be700c8763c26054098348ebef8d6}{hostname}[0] = \textcolor{charliteral}{'\(\backslash\)0'};
76   \_socket->\hyperlink{structess__socket_a4d0d74743d167680649419163ce8c80e}{hostname\_len} = strlen(hostname);
77 
78     strncpy(\_socket->\hyperlink{structess__socket_a0c6be700c8763c26054098348ebef8d6}{hostname}, hostname, strlen(hostname));
79 
80 
...
\begin{center}
\leavevmode
\includegraphics[width=336pt]{d7/d06/ess__socket_8c_a62c983ed003d1db7341a50b0ef1a98ed_icgraph}
\end{center}
\end{figure}
\mbox{\Hypertarget{ess__socket_8c_a8ba8f229958de5d36ad07b24f782a342}\label{ess__socket_8c_a8ba8f229958de5d36ad07b24f782a342}} 
...
178 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a03a4601382a1dabaf2c8946191ea7c08}\label{ess__socket_8c_a03a4601382a1dabaf2c8946191ea7c08}} 
...
163 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a57c8d39ed9fc55eba03837238cb08557}\label{ess__socket_8c_a57c8d39ed9fc55eba03837238cb08557}} 
...
153 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a944f0798ea120bef422f97909451b1a9}\label{ess__socket_8c_a944f0798ea120bef422f97909451b1a9}} 
...
480 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_abe25e0d1df2293293f0aa3ee0dedadcf}\label{ess__socket_8c_abe25e0d1df2293293f0aa3ee0dedadcf}} 
...
462 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a54f5a1366f009fc50e193874d71b7d7f}\label{ess__socket_8c_a54f5a1366f009fc50e193874d71b7d7f}} 
...
246 
247   setsockopt( \_socket->\hyperlink{structess__socket_a3666576f6b88007cc7b8f26c7da596c8}{socket}, SOL\_SOCKET, SO\_SNDBUF, &send\_buffer\_size, \textcolor{keyword}{sizeof}( send\_buffer\_size ) )
      ;
248   setsockopt( \_socket->\hyperlink{structess__socket_a3666576f6b88007cc7b8f26c7da596c8}{socket}, SOL\_SOCKET, SO\_RCVBUF, &rec\_buffer\_size, \textcolor{keyword}{sizeof}( rec\_buffer\_size ) );
249 
...
251 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a1cda1ccc6857cde561484dd998124bd7}\label{ess__socket_8c_a1cda1ccc6857cde561484dd998124bd7}} 
...
497 \}
\end{DoxyCode}
\mbox{\Hypertarget{ess__socket_8c_a62b826aa7c650a8d4dc447f029364a94}\label{ess__socket_8c_a62b826aa7c650a8d4dc447f029364a94}} 
