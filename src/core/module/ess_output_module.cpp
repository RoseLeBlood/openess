...
ess_error_t ess_output_module::connect(ess_effect* effect, ess_audio_channel channel) {
  return get_channel(channel)->connect(effect->get_channel(channel) );
}

ess_error_t ess_output_module::connect(ess_effect* effect, ess_audio_channel this_channel,
  ess_audio_channel mod_channel) {
  return get_channel(this_channel)->connect(effect->get_channel(mod_channel));
}
