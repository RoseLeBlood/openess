...
#define ESS_PI                          3.1415926535897932384626433832795
#define ESS_HALF_PI             1.5707963267948966192313216916398
#define ESS_TWO_PI               6.283185307179586476925286766559
#define ESS_DEG_TO_RAD    0.017453292519943295769236907684886
#define ESS_RAD_TO_DEG    57.295779513082320876798154814105
#define ESS_EULER                 2.718281828459045235360287471352

#define ess_abs(x) ((x)>0?(x):-(x))

#define ESS_RAD(deg) ((deg)*ESS_DEG_TO_RAD)
#define ESS_DEG(rad) ((rad)*ESS_RAD_TO_DEG)
